...
function AboutMe() {
    return <Container className='lightSection sections' id='aboutMe'>
        <Row className='p-5'>
            ...
            <div>
                <a href="https://www.linkedin.com/in/tony-klinpon/" target="_blank"><FontAwesomeIcon icon={faLinkedin} className='icon' /></a>
                <a href="https://www.github.com/tonytkl" target="_blank"><FontAwesomeIcon icon={faGithub} className='icon' /></a>
            </div>
        </Row>
    </Container>
}
